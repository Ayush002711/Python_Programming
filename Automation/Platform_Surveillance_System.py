...
def send_mail(reciver,filename,data):
	...
	Please cheak the attch log file 
    """
...
def main():
    ...
    if(len(sys.argv) == 2):
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("2 : It featch information about the primary storage RAM")
            ...
            print("7 : It sends the log file thrugh mail periodically")
